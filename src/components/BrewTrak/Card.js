...
const Card = ({img, date, brewType, beanType, beanWeight, waterWeight, beanGrind, waterTemp, comments, rating, setCardValues}) => {
    ...
    let card = {img, date, brewType, beanType, beanWeight, waterWeight, beanGrind, waterTemp, comments, rating };
    return(
