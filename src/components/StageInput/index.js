    ...
    <div className='text-gray-700'>
      <div className='mb-2'>
        ...
        <input
          ...
          className='text-center form-input block w-full text-sm sm:leading-5 mt-1 rounded-md shadow-sm'
        />
      </div>
      <div className='mb-2'>
        <label className='block text-sm font-medium leading-5'>
          total weight by stage end{' '}
        </label>
        ...
        <div className='flex items-end'>
          <div>
            ...
            <input
              ...
              min='0'
              max='59'
              className='text-center text-xs sm:px-2 form-input block w-full mt-1 rounded-md shadow-sm'
            />
          </div>
          <p className='mx-2'>:</p>
          <div>
