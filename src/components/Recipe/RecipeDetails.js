    ...
    <main className='py-10'>
      ...
      <div className='mt-8 max-w-3xl mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-cols-3'>
              ...
              <div className='border-t border-gray-200 px-4 py-5 sm:px-6'>
                <dl className='grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2'>
                  <div className='sm:col-span-1'>
                    ...
                    <dd className='mt-1 text-sm text-gray-900'>{brew_type}</dd>
                  </div>
                  <div className='sm:col-span-1'>
                    <dt className='text-sm font-medium text-gray-500'>
                      Bean Weight
                  ...
                  <div className='sm:col-span-1'>
                    ...
                    <dd className='mt-1 text-sm text-gray-900'>{bean_grind}</dd>
                  </div>
                  <div className='sm:col-span-1'>
                    <dt className='text-sm font-medium text-gray-500'>
                      Water Amount
        ...
        <section
          ...
          className='order-first sm:order-none lg:col-span-1'
        >
