    ...
    <div className='space-y-8'>
      <div className='h-screen-3/4 bg-cover px-8 py-6 flex flex-col items-center justify-center' style={{ backgroundImage: `url(${CoffeeCover})` }}>
        ...
        <div className='text-center space-y-2'>
          <h1 className='text-4xl tracking-tight font-extrabold sm:text-5xl md:text-6xl text-white'>Discover the world of coffee</h1>
          <h2 className='sm:text-lg md:text-xl text-gray-100'>Explore and share coffee recipes, reviews, and more</h2>
        </div>

        <form onSubmit={onSubmit} className="mt-6 flex rounded-md shadow-lg w-full sm:w-2/3 lg:w-1/2 xl:w-1/3">
