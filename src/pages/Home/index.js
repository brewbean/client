...
import { Beans, PourOver, Scale } from 'image'

export default function Home() {
  return (
    <div className='space-y-12 md:space-y-24'>
      <div className='space-y-8'>
        <h1 className='text-4xl tracking-tighter font-extrabold sm:text-5xl md:text-7xl text-gray-900'>
          Your one stop coffee community.
        </h1>

        <h2 className='max-w-xl sm:text-md md:text-lg font-light text-gray-800'>
          Discover the world of coffee. We make it easy to share recipes, bean
        ...
        <dl className='mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2'>
          <div>
            ...
            <div className='mt-5'>
              ...
              <dd className='mt-2 text-base text-gray-500'>
                Discover hidden gems of roasters and beans that would be hard to
          ...
          <div>
            ...
            <div className='mt-5'>
              ...
              <dd className='mt-2 text-base text-gray-500'>
                With our recipe player, you can easily try any recipe you or the
                community created.
              </dd>
            </div>
          </div>
