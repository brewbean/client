    ...
    <form className="space-y-2" onSubmit={submitLogin}>
      <div>
        ...
        <div className="mt-2 rounded-md shadow-sm">
          <input type="email" name='email' value={email} onChange={onChange} id="email" autoComplete="email" required
      ...
      <div>
        ...
        <div className="mt-2 rounded-md shadow-sm">
          <input type="text" name='displayName' value={displayName} onChange={onChange} id="display-name" required minLength="3"
            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
        </div>
      </div>
      <div>
        ...
        <div className="mt-2 relative rounded-md shadow-sm">
          <input type={showPassword ? "text" : "password"} name='password' value={password} onChange={onChange} id="password" autoComplete="new-password" required minLength="8" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$"
            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
